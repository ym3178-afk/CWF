(function () {
  ...
  var relationshipMeta = {
    control: { label: "Control", color: "#ff5c5c", curve: -20 },
    data: { label: "Data", color: "#7c5cff", curve: 20 },
    exchange: { label: "Exchange", color: "#4da3ff", curve: -12 },
    governance: { label: "Governance", color: "#f6c85f", curve: 14 },
    collective: { label: "Collective", color: "#ff7fd1", curve: -16 },
    outcome: { label: "Outcome", color: "#a8b3cf", curve: 12 }
  };
